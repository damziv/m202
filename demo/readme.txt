...
十二. Python3扩展库:
	...
	ffmpeg系列动态库
十三、新增测试命令
     读取有线网卡mac地址: llua.exe demo/nspp/t_get_ipv4.lua
	设置有线网卡mac地址: llua.exe demo/nspp/t_set_ipv4.lua
	读取无线网卡mac地址: llua.exe demo/nspp/t_wireless_get_ipv4.lua
	设置无线网卡mac地址: llua.exe demo/nspp/t_wireless_set_ipv4.lua
	读取相机型号(model): llua.exe demo/nspp/t_base.lu
	读取wifiAp模式密码:  llua.exe demo/nspp/t_wireless_get_apAndsta.lua
	设置wifiAp模式密码:  llua.exe demo/nspp/t_wireless_set_ap.lua
	读取手动曝光参数: 	 llua.exe demo/nspp/t_get_img_ME_exposure.lua
	设置手动曝光参数: 	 llua.exe demo/nspp/t_set_img_ME_exposure.lua
